...
import "../../App.css"
export default function MyDropzone({label}) {
    ...
    return (
        <div className="p-5">
            ...
            <div className="p-5 border-dashed border-1">
                {dataURL ? (
                    <div className="relative">
                        <img src={dataURL} className="min-w-[200px] max-w-[500px] min-h-[100px] max-h-[200px]" />
