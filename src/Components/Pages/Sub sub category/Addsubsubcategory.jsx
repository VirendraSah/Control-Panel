      ...
      <section className='px-5'>
        <div className='border rounded'>
          <div className='border-b rounded-t py-3 px-2 bg-[#f1f5f9]'>
            <div className='w-full text-[20px] font-semibold leading-7'>Add Sub Category</div>
          </div>
          <div className='py-2'>
            <form action="">
              <div className="flex w-full">
                ...
                <div className="w-full">
                  ...
                  <Selectinput label={'Sub Category Name'} selected={'Select Category'} value={SelectInputValue} />
